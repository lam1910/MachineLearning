...
dataset = pd.read_csv(r"~/machineLearning/Machine-Learning-A-Z-New/Machine Learning A-Z New/Part 3 - Classification/Section 20 - Random Forest Classification/Social_Network_Ads.csv")
...
#no need, since not based on euclidean distance
...
#random forest
#fiting random forest model to dataset
...
#visuallising the tranning set results in random forest model
...
#visuallising the test set results in random forest model
from matplotlib.colors import ListedColormap
