...
dataset = pd.read_csv(r"~/machineLearning/Machine-Learning-A-Z-New/Machine Learning A-Z New/Part 3 - Classification/Section 16 - Support Vector Machine (SVM)/Social_Network_Ads.csv")
...
#fiting support vector machine model to dataset
...
#visuallising the tranning set results in support vector machine model
...
#visuallising the test set results in support vector machine model
from matplotlib.colors import ListedColormap
