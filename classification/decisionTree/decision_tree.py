...
dataset = pd.read_csv(r"~/machineLearning/Machine-Learning-A-Z-New/Machine Learning A-Z New/Part 3 - Classification/Section 19 - Decision Tree Classification/Social_Network_Ads.csv")
...
#decision tree
#fiting decision tree to dataset
...
#visuallising the tranning set results in decision tree model
