...
dataset = pd.read_csv(r"~/machineLearning/Machine-Learning-A-Z-New/Machine Learning A-Z New/Part 3 - Classification/Section 18 - Naive Bayes/Social_Network_Ads.csv")
...
#visuallising the tranning set results in naive bayes model
...
#visuallising the test set results in naive bayes model
from matplotlib.colors import ListedColormap
